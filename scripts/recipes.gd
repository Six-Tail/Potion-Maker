...
var INGREDIENTS := {
	"herb":     {"name": "약초",   "color": Color("6cbf5a"), "shape": "leaf"},
	"mushroom": {"name": "버섯",   "color": Color("b5533b"), "shape": "mushroom"},
	"crystal":  {"name": "수정",   "color": Color("57c7e3"), "shape": "crystal"},
	"slime":    {"name": "슬라임", "color": Color("9ad84a"), "shape": "blob"},
	"ember":    {"name": "불꽃",   "color": Color("ef8b3b"), "shape": "flame"},
	"dew":      {"name": "이슬",   "color": Color("a9d9ff"), "shape": "drop"},
	"bone":     {"name": "뼈",     "color": Color("e8e2cf"), "shape": "bone"},
	"petal":    {"name": "꽃잎",   "color": Color("f2a6c8"), "shape": "petal"},
}
...
var UNKNOWN := {
	"id": "unknown", "name": "정체불명의 물약", "color": Color("8a7fa6"),
	"desc": "탁하고 미심쩍은 액체. 이게 대체 뭐지…?",
}
var FAILURE := {
	"id": "failure", "name": "맹물", "color": Color("cfe6f2"),
